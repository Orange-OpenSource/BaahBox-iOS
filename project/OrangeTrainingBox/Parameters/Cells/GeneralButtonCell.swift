...
class GeneralButtonCell: UITableViewCell {
    ...
    func configure(activeButton: Bool) {
        let textContent = NSMutableAttributedString(string: L10n.Generic.disconnect,
                                    attributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: 18, weight: .bold),
                                                 NSAttributedString.Key.foregroundColor: activeButton ? UIColor.red: UIColor.lightGray])
